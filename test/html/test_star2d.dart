...
void testLifecycle() {
  ...
  ButtonElement enterButton = querySelector("#star2d-enter-button");
  ...
  ButtonElement updateButton = querySelector("#star2d-update-button");
  ...
  ButtonElement exitButton = querySelector("#star2d-exit-button");
