...
class TestCross2d implements AfterViewInit {
  ...
  void testBasic(EnvyScene e) {
    ...
    s.verticalWidth.enter = NumberConstant(10);
    s.verticalHeight.enter = NumberConstant(50);
    s.horizontalWidth.enter = NumberConstant(30);
    s.horizontalHeight.enter = NumberConstant(5);
    s.percent.enter = NumberConstant(33);
  ...
  void testLifecycle(EnvyScene e) {
    ...
    updateButton.onClick.listen((_) {
      ...
      s.verticalWidth.update = NumberConstant(15);
      s.verticalHeight.update = NumberConstant(60);
      s.horizontalWidth.update = NumberConstant(40);
      s.horizontalHeight.update = NumberConstant(10);
      s.percent.update = NumberConstant(40);
  ...
  void testDataDriven(EnvyScene e) {
    ...
    s.x.enter = NumberData('rectdata', canvas, prop: 'xcoord');
    s.y.enter = NumberData('rectdata', canvas, prop: 'ycoord');
    s.verticalWidth.enter = NumberConstant(10);
    s.verticalHeight.enter = NumberConstant(50);
    s.horizontalWidth.enter = NumberConstant(30);
    s.horizontalHeight.enter = NumberConstant(5);
    s.percent.enter = NumberConstant(33);
    s.opacity.enter = NumberData('rectdata', canvas, prop: 'opacity');
