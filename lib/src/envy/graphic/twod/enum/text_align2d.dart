...
class TextAlign2d extends Enumeration<String> {
  ...
  static const TextAlign2d start = TextAlign2d('start');

  /// Text alignment: end.
  static const TextAlign2d end = TextAlign2d('end');

  /// Text alignment: left.
  static const TextAlign2d left = TextAlign2d('left');

  /// Text alignment: right.
  static const TextAlign2d right = TextAlign2d('right');

  /// Text alignment: center.
  static const TextAlign2d center = TextAlign2d('center');
