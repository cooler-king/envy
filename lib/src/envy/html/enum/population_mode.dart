...
class PopulationMode extends Enumeration<String> {
  ...
  static const PopulationMode independent = PopulationMode('independent');
  ...
  static const PopulationMode distribute = PopulationMode('distribute');

  /// Populates the DOM nodes of an Envy `HtmlNode` parent with a single node.
  /// Ignores any missing or extra children.
  static const PopulationMode parallel = PopulationMode('parallel');

  /// Populates the DOM nodes of an Envy `HtmlNode` parent with a single node.
  /// Ignores any missing or extra children.
  static const PopulationMode parallelExtrapolate = PopulationMode('parallel');
}
