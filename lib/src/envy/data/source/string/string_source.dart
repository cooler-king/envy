...
class StringConstant extends ArrayDataSource<String> implements StringSource {
  /// Constructs a instance from an existing String.
  StringConstant(String str) {
    values.add(str);
  }

  /// Constructs a instance from an existing list of String.
  StringConstant.array(List<String> strings) {
    values.addAll(strings);
  }

  /// Constructs a instance from a specific enumerated String value.
  StringConstant.enumerationValue(Enumeration<String> e) {
    values.add(e.value);
  }

  /// An empty String.
  static final StringConstant empty = StringConstant('');
