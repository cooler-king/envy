...
class Color implements CssAdapter {
  ...
  /// Gray (#eee).
  static const Color grayEEE = Color(0.9375, 0.9375, 0.9375);

  /// Gray (#ddd).
  static const Color grayDDD = Color(0.875, 0.875, 0.875);

  /// Gray (#ccc).
  static const Color grayCCC = Color(0.8125, 0.8125, 0.8125);

  /// Gray (#bbb).
  static const Color grayBBB = Color(0.75, 0.75, 0.75);

  /// Gray (#aaa).
  static const Color grayAAA = Color(0.6875, 0.6875, 0.6875);

  /// Gray (#999).
  static const Color gray999 = Color(0.625, 0.625, 0.625);

  /// Gray (#888).
  static const Color gray888 = Color(0.5625, 0.5625, 0.5625);

  /// Gray (#777).
  static const Color gray777 = Color(0.5, 0.5, 0.5);

  /// Gray (#666).
  static const Color gray666 = Color(0.4375, 0.4375, 0.4375);

  /// Gray (#555).
  static const Color gray555 = Color(0.375, 0.375, 0.375);

  /// Gray (#444).
  static const Color gray444 = Color(0.3125, 0.3125, 0.3125);

  /// Gray (#333).
  static const Color gray333 = Color(0.25, 0.25, 0.25);

  /// Gray (#222).
  static const Color gray222 = Color(0.1875, 0.1875, 0.1875);

  /// Gray (#111).
  static const Color gray111 = Color(0.0625, 0.0625, 0.0625);
  ...
  Color derive({double brightness, double saturation}) {
    final hueSatBr = hsb;
    final s = saturation ?? hueSatBr[1];
    final b = brightness ?? hueSatBr[2];

    final rgb = hsbToRgb(hueSatBr[0], s, b);
